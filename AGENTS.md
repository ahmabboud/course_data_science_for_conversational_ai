...
lectures/
  ...
  _reference.html              The worked example. A built deck from another course on this
                               same system. Read it before writing your own; it is not part of
                               this course and is not linked from index.html.
```
...
Copy these from `_reference.html` rather than composing from scratch.
